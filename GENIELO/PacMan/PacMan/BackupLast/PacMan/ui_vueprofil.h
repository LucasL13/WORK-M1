...
public:
    ...
    void setupUi(QMainWindow *VueProfil)
    {
        ...
        changeProfile = new QPushButton(centralwidget);
        changeProfile->setObjectName(QStringLiteral("changeProfile"));
        changeProfile->setGeometry(QRect(80, 320, 261, 61));
    ...
    void retranslateUi(QMainWindow *VueProfil)
    {
        ...
        changeProfile->setText(QApplication::translate("VueProfil", "Changer de profil", Q_NULLPTR));
    } // retranslateUi
